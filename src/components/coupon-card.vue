    ...
    <section class="ft-coupon-card" v-for="(card, index) in cards" :key="index">
      <div class="ft-coupon-card-body">
        <div class="ft-coupon-money">
          <div
              :class='[card["type"] === "discount" ? "ft-coupon-discount ft-coupon-discount-plus" : "ft-coupon-discount"]'>
...
<script lang="ts">
  ...
  export default class CouponCard extends Vue {
    ...
    private couponText: object = {
      ...
      C: {
        title: '更多用户通用券',
        discount: '最高抵扣PRICE元，限购买"推广给更多用户"使用，包括潜在粉丝、兴趣用户、指定账号的相似粉丝、指定商圈用户、关键词搜索用户。',
        full: '满FULL元可用，限购买"推广给更多用户"使用,包括潜在粉丝、兴趣用户、指定账号的相似粉丝、指定商圈用户、关键词搜索用户。'
      },
      ...
      H: {
        title: '指定账号券',
        discount: '满FULL元可用，仅限购买"推广给更多用户"中的指定账号的相似粉丝使用。',
        full: '满FULL元可用，仅限购买"推广给更多用户"中的指定账号的相似粉丝使用。'
      },
