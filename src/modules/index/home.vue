<template>
  <div class="hk-data-report">
    <header class="hk-data-report__header"></header>
    <nav
      class="hk-data-report__nav"
      :class="size ? 'open' : ''"
      @click="resize"
    />
